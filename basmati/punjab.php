        ...
        <div class="row">
            <div class="col-12">
                <ul class="page-breadcrumb__menu">
                    ...
                    <li class="page-breadcrumb__nav active"><a href="basmati.php">Basmati</a></li>
                </ul>
                ...
                <div class="col-md-5">
                    <div class="product-gallery-box m-b-0">
                        <div class="product-image--gallery overflow-hidden">
                            <h4 class="font--regular m-b-20">PUNJAB BASMATI RICE
                            </h4>
                            <div class="float-left float-grid-1 m-t-0">
                            <div class="img-wrapper">
                                    <img src="../assets/img/product/basmati/punjab.jpg" alt="Rice Image" class="prd-img">
                    ...
                    <div class="product-details-box m-b-0">
                        ...
                        <div class="mt12px pt22px bdrT proDtls">
                            ...
                            <table class="w100 mb15px formTable ">
                                <p>Punjab Basmati Rice is a premium, long-grain rice variety known for its rich aroma, fluffy texture, and exceptional taste, making it ideal for biryanis and other traditional dishes.
                                </p>
                                <!--<h5>Features</h5>-->
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="p7px">Punjab Basmati Rice</td>
                                    </tr>
                                    <tr>
