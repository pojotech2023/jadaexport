                ...
                <div class="col-md-5">
                    <div class="product-gallery-box m-b-0">
                        <div class="product-image--gallery overflow-hidden">
                            <h4 class="font--regular m-b-20">HARYANA BASMATI RICE
                            </h4>
                            <div class="float-left float-grid-1 m-t-0">
                            <div class="img-wrapper">
                                    <img src="../assets/img/product/basmati/haryana.webp" alt="Rice Image" class="prd-img">
                    ...
                    <div class="product-details-box m-b-0">
                        ...
                        <div class="mt12px pt22px bdrT proDtls">
                            ...
                            <table class="w100 mb15px formTable ">
                                <p>Haryana Basmati Rice is a superior long-grain variety known for its rich aroma, non-sticky texture, and excellent taste, making it perfect for biryanis and pulao.</p>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="p7px">Haryana Basmati Rice</td>
                                    </tr>
                                    <tr>
