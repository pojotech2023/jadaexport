                ...
                <div class="col-md-5">
                    <div class="product-gallery-box m-b-0">
                        <div class="product-image--gallery overflow-hidden">
                            <h4 class="font--regular m-b-20">BASMATI 1121 RICE
                            </h4>
                            <div class="float-left float-grid-1 m-t-0">
                            <div class="img-wrapper">
                                    <img src="../assets/img/product/basmati/basmati_1211.jpg" alt="Rice Image" class="prd-img">
                    ...
                    <div class="product-details-box m-b-0">
                        ...
                        <div class="mt12px pt22px bdrT proDtls">
                            ...
                            <table class="w100 mb15px formTable ">
                                <p>Basmati 1121 Rice is a premium, extra-long grain variety known for its delicate aroma, fluffy texture, and non-sticky nature, making it ideal for biryanis and gourmet dishes.
                                </p>
                                <!--<h5>Features</h5>-->
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="p7px">Basmati 1121 Rice</td>
                                    </tr>
                                    <tr>
