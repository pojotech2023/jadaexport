        ...
        <div class="row">
            <div class="col-12">
                <ul class="page-breadcrumb__menu">
                    ...
                    <li class="page-breadcrumb__nav active">Basmati</li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="product__box product__default--single text-center col-md-4">
                <div class="product__img-box  pos-relative">
                    ...
                    <ul class="product__action--link pos-absolute">
                        <li><a href="punjab.php"><i class="icon-eye"></i></a></li>
                    </ul>
                </div>
            ...
            <div class="product__box product__default--single text-center col-md-4">
                <div class="product__img-box  pos-relative">
                    ...
                    <ul class="product__action--link pos-absolute">
                        <li><a href="haryana.php"><i class="icon-eye"></i></a></li>
                    </ul>
                </div>
            ...
            <div class="product__box product__default--single text-center col-md-4">
                <div class="product__img-box  pos-relative">
                    ...
                    <ul class="product__action--link pos-absolute">
                        <li><a href="basmati_1121.php"><i class="icon-eye"></i></a></li>
                    </ul>
                </div>
            ...
            <div class="product__box product__default--single text-center col-md-4">
                <div class="product__img-box  pos-relative">
                    ...
                    <ul class="product__action--link pos-absolute">
                        <li><a href="golden_sella.php"><i class="icon-eye"></i></a></li>
                    </ul>
                </div>
            ...
            <div class="product__box product__default--single text-center col-md-4">
                <div class="product__img-box  pos-relative">
                    ...
                    <ul class="product__action--link pos-absolute">
                        <li><a href="cream_sella.php"><i class="icon-eye"></i></a></li>
                    </ul>
                </div>
