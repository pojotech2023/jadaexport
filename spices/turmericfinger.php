...
<div class="page-breadcrumb">
    ...
    <main id="main-container" class="main-container m-t-100">
                   ...
                   <div class="col-md-5">
                        <div class="product-gallery-box m-b-0">
                            <div class="product-image--gallery overflow-hidden">
                                <h4 class="font--regular m-b-20">TURMERIC FINGER 

</h4>
                                <div class="float-left float-grid-1 m-t-0">
                                    <div class="img-responsive border-around">
                                        <img src="../assets/img/product/size-normal/turmericfinger.png" alt="">                  
                                    </div>
                                </div>
		...
		<table>
            <p>The turmeric finger is the purest form of turmeric and is used in medicines, food and dyeing processes. The product is sourced from the farmers who grow the crop in natural and organic manner. Turmeric is widely grown in Erode. Turmeric powder is made from turmeric fingers.</p>
				<tbody>
				
				<tr>
				    <td class="p7px alpha75 w33">Product Name:</td>
			         <td class="p7px">Turmeric Finger</td>
				</tr>
