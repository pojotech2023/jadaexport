...
<div class="page-breadcrumb">
    ...
    <main id="main-container" class="main-container m-t-100">
                   ...
                   <div class="col-md-5">
                        <div class="product-gallery-box m-b-0">
                            <div class="product-image--gallery overflow-hidden">
                                <h4 class="font--regular m-b-20">CLOVES
</h4>
                                <div class="float-left float-grid-1 m-t-0">
                                    <div class="img-responsive border-around">
                                        <img src="../assets/img/product/size-normal/cloves.png" alt="">                  
                                    </div>
                                </div>
		...
		<table>
            <p>clove, (Syzygium aromaticum), tropical evergreen tree of the family Myrtaceae and its small reddish brown flower buds used as a spice. Cloves were important in the earliest spice trade and are believed to be indigenous to the Moluccas, or Spice Islands, of Indonesia.</p>
				<tbody>
				
				<tr>
				    <td class="p7px alpha75 w33">Product Name:</td>
			         <td class="p7px">Cloves</td>
				</tr>
