...
<div class="page-breadcrumb">
        ...
        <div class="row">
            <div class="col-12">
                <ul class="page-breadcrumb__menu">
                    ...
                    <li class="page-breadcrumb__nav active"><a href="spices.php">Spices</a></li>
                </ul>
    ...
    <main id="main-container" class="main-container m-t-100">
                   ...
                   <div class="col-md-5">
                        <div class="product-gallery-box m-b-0">
                            <div class="product-image--gallery overflow-hidden">
                                <h4 class="font--regular m-b-20">CORIANDER SEEDS
</h4>
                                <div class="float-left float-grid-1 m-t-0">
                                    <div class="img-responsive border-around">
                                        <img src="../assets/img/product/size-normal/corianderseeds.png" alt="">                  
                                    </div>
                                </div>
		...
		<table>
            <p>Coriander seed, which are actually the dried fruit of the coriander plant, is used as a spice. Typically used ground, coriander seed has a spicy, citrus flavor. Coriander seed is used extensively in Indian, Middle Eastern and Asian cuisines. Whole coriander seed is sometimes used in pickling and brining.</p>
				<tbody>
				
				<tr>
				    <td class="p7px alpha75 w33">Product Name:</td>
			         <td class="p7px">Coriander Seeds</td>
				</tr>
