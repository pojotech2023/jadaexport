...
<div class="page-breadcrumb">
    ...
    <main id="main-container" class="main-container m-t-100">
                   ...
                   <div class="col-md-5">
                        <div class="product-gallery-box m-b-0">
                            <div class="product-image--gallery overflow-hidden">
                                <h4 class="font--regular m-b-20">RED CHILLI
</h4>
                                <div class="float-left float-grid-1 m-t-0">
                                    <div class="img-responsive border-around">
                                        <img src="../assets/img/product/size-normal/redchilli.png" alt="">                  
                                    </div>
                                </div>
		...
		<table>
            <p>anise, (Pimpinella anisum), annual herb of the parsley family (Apiaceae), cultivated chiefly for its fruits, called aniseed, the flavour of which resembles that of licorice.</p>
				<tbody>
				
				<tr>
				    <td class="p7px alpha75 w33">Product Name:</td>
			         <td class="p7px">Red Chilli</td>
				</tr>
