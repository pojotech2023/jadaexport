...
<div class="page-breadcrumb">
    ...
    <main id="main-container" class="main-container m-t-100">
                   ...
                   <div class="col-md-5">
                        <div class="product-gallery-box m-b-0">
                            <div class="product-image--gallery overflow-hidden">
                                <h4 class="font--regular m-b-20">FENNEL SEEDS</h4>
                                <div class="float-left float-grid-1 m-t-0">
                                    <div class="img-responsive border-around">
                                        <img src="../assets/img/product/size-normal/fennelseeds.png" alt="">                  
                                    </div>
                                </div>
                            </div>
                        </div>
		...
		<table>
            <p>Extracted garlic powder from Dehydrated Garlic Flakes is easy to bring the flavour of fresh garlic. The pungent and spicy powder beats the garlicky heat, replace and mimic the natural pinch of yum.</p>
				<tbody>
				
				<tr>
				    <td class="p7px alpha75 w33">Product Name:</td>
			         <td class="p7px">Fennel Seeds</td>
				</tr>
