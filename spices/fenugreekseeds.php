...
<div class="page-breadcrumb">
    ...
    <main id="main-container" class="main-container m-t-100">
                   ...
                   <div class="col-md-5">
                        <div class="product-gallery-box m-b-0">
                            <div class="product-image--gallery overflow-hidden">
                                <h4 class="font--regular m-b-20">FENUGREEK SEEDS
</h4>
                                <div class="float-left float-grid-1 m-t-0">
                                    <div class="img-responsive border-around">
                                        <img src="../assets/img/product/size-normal/fenugreekseeds.png" alt="">                  
                                    </div>
                                </div>
		...
		<table>
            <p>Fenugreek, Trigonella foenum-graecum, is an herbaceous annual plant in the family Fabaceae grown for its leaves and seeds which are used as a herb or spice. The fenugreek plant may have a single stem or may be branched at the stem base. The plant has an erect growth habit and a strong, sweet aroma.</p>
				<tbody>
				
				<tr>
				    <td class="p7px alpha75 w33">Product Name:</td>
			         <td class="p7px">Fenugreek Seeds</td>
				</tr>
