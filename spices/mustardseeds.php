...
<div class="page-breadcrumb">
    ...
    <main id="main-container" class="main-container m-t-100">
                   ...
                   <div class="col-md-5">
                        <div class="product-gallery-box m-b-0">
                            <div class="product-image--gallery overflow-hidden">
                                <h4 class="font--regular m-b-20">MUSTARD SEEDS
</h4>
                                <div class="float-left float-grid-1 m-t-0">
                                    <div class="img-responsive border-around">
                                        <img src="../assets/img/product/size-normal/mustardseeds.png" alt="">                  
                                    </div>
                                </div>
		...
		<table>
            <p>Mustard seeds, both white and brown, are nearly globular in shape, finely pitted, odourless when whole, and pungent-tasting. White mustard seeds are light yellow in colour and about 2.5 mm (0.1 inch) in diameter. Brown mustard seeds are about the same size but are a darker yellow in colour.</p>
				<tbody>
				
				<tr>
				    <td class="p7px alpha75 w33">Product Name:</td>
			         <td class="p7px">Mustard Seeds</td>
				</tr>
