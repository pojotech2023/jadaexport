...
<div class="page-breadcrumb">
    ...
    <main id="main-container" class="main-container m-t-100">
                   ...
                   <div class="col-md-5">
                        <div class="product-gallery-box m-b-0">
                            <div class="product-image--gallery overflow-hidden">
                                <h4 class="font--regular m-b-20">DRIED GINGER
</h4>
                                <div class="float-left float-grid-1 m-t-0">
                                    <div class="img-responsive border-around">
                                        <img src="../assets/img/product/size-normal/driedginger.png" alt="">                  
                                    </div>
                                </div>
		...
		<table>
            <p>Dried ginger is nothing but fresh ginger, which has undergone a drying process. The fresh rhizomes are soaked in water overnight after which the outer peel is carefully removed using a knife or a peeler. They are washed again and then sun-dried on mats or barbecues for around a week.</p>
				<tbody>
				
				<tr>
				    <td class="p7px alpha75 w33">Product Name:</td>
			         <td class="p7px">Dried Ginger</td>
				</tr>
