    ...
    <main id="main-container" class="main-container m-t-100">
        ...
        <div class="container">
            <div class="row">	
                ...
                <div class="col-md-3 text-center" style="border: 1px solid #111;">
                    <a href="assets/img/certificate/offiec.png" target="_blank">
                        <img src="assets/img/certificate/offiec.png" style="width:100%;">
                    </a>
                </div>
                <div class="col-md-3 text-center">
                    <a href="assets/img/certificate/spices.png" target="_blank">
            ...
            <!-- <div class="row">  
                ...
                <div class="col-md-3 text-center">
                    <a href="assets/img/certificate/license.png" target="_blank">
                        <img src="assets/img/certificate/license.png" style="width:100%;">
                    </a>
                </div>
                <div class="col-md-3 text-center" style="border: 1px solid #111;">
