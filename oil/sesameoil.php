...
<div class="page-breadcrumb">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <li class="page-breadcrumb__nav"><a href="../index.php">Home</a></li>
                    ...
                    <li class="page-breadcrumb__nav active"><a href="oil.php">Oil</a></li>
                </ul>
    ...
    <main id="main-container" class="main-container m-t-100">
                   ...
                   <div class="col-md-5">
                        <div class="product-gallery-box m-b-0">
                            <div class="product-image--gallery overflow-hidden">
                                <h4 class="font--regular m-b-20">SESAME OIL</h4>
                                <div class="float-left float-grid-1 m-t-0">
                                    <div class="img-responsive border-around">
                                        <img src="../assets/img/product/oil/sesameoil.png" alt="">                  
                                    </div>
                                </div>
		...
		<table>
            <p>Sesame oil made from seeds that have not been toasted is a pale yellow liquid with a pleasant grain-like odor and somewhat nutty taste, and is used as frying oil. Oil made from pressed and toasted sesame seeds is amber-colored and aromatic, and is used as a flavoring agent in the final stages of cooking.</p>
				<tbody>
				
				<tr>
				    <td class="p7px alpha75 w33">Product category:</td>
			         <td class="p7px">Sesame Oil</td>
				</tr>
				...
				<tr>
				   <td class="p7px alpha75 w33">Packing:</td>
			         <td class="p7px">As per  buyers request</td>  
				</tr>
				<tr>
