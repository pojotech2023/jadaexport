...
<div class="page-breadcrumb">
    ...
    <main id="main-container" class="main-container m-t-100">
                   ...
                   <div class="col-md-5">
                        <div class="product-gallery-box m-b-0">
                            <div class="product-image--gallery overflow-hidden">
                                <h4 class="font--regular m-b-20">EDIBLE OILS
</h4>
                                <div class="float-left float-grid-1 m-t-0">
                                    <div class="img-responsive border-around">
                                        <img src="../assets/img/product/oil/edibleoils.png" alt="">                  
                                    </div>
                                </div>
		...
		<table>
            <p>Edible or cooking oil is fat of plant, animal or microbial origin, which is liquid at room temperature and is suitable for food use.</p>
				<tbody>
				
				<tr>
				    <td class="p7px alpha75 w33">Product Name:</td>
			         <td class="p7px">Edible Oils</td>
				</tr>
