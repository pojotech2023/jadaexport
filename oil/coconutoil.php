...
<div class="page-breadcrumb">
    ...
    <main id="main-container" class="main-container m-t-100">
                            ...
                            <div class="product-image--gallery overflow-hidden">
                                ...
                                <div class="float-left float-grid-1 m-t-0">
                                    <div class="img-responsive border-around">
                                        <img src="../assets/img/product/oil/coconutoil.png" alt="">                  
                                    </div>
                                </div>
		...
		<table>
            <p>Coconut oil is 100% fat, 80-90% of which is saturated fat. This gives it a firm texture at cold or room temperatures. Fat is made up of smaller molecules called fatty acids, and there are several types of saturated fatty acids in coconut oil.</p>
				<tbody>
				
				<tr>
				    <td class="p7px alpha75 w33">Product Name:</td>
			         <td class="p7px">Coconut Oil</td>
				</tr>
