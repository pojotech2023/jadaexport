        ...
        <div class="row">
            <div class="product__box product__default--single text-center col-md-4">
                <div class="product__img-box  pos-relative">
                    ...
                    <ul class="product__action--link pos-absolute">
                        <li><a href="barnyard_millet.php"><i class="icon-eye"></i></a></li>
                    </ul>
                </div>
            ...
            <div class="product__box product__default--single text-center col-md-4">
                <div class="product__img-box  pos-relative">
                    ...
                    <ul class="product__action--link pos-absolute">
                        <li><a href="browntop_millet.php"><i class="icon-eye"></i></a></li>
                    </ul>
                </div>
            ...
            <div class="product__box product__default--single text-center col-md-4">
                <div class="product__img-box  pos-relative">
                    ...
                    <ul class="product__action--link pos-absolute">
                        <li><a href="finger_millet.php"><i class="icon-eye"></i></a></li>
                    </ul>
                </div>
            ...
            <div class="product__box product__default--single text-center col-md-4">
                <div class="product__img-box  pos-relative">
                    ...
                    <ul class="product__action--link pos-absolute">
                        <li><a href="foxtail_millet.php"><i class="icon-eye"></i></a></li>
                    </ul>
                </div>
            ...
            <div class="product__box product__default--single text-center col-md-4">
                <div class="product__img-box  pos-relative">
                    ...
                    <ul class="product__action--link pos-absolute">
                        <li><a href="kodo_millet.php"><i class="icon-eye"></i></a></li>
                    </ul>
                </div>
            ...
            <div class="product__box product__default--single text-center col-md-4">
                <div class="product__img-box  pos-relative">
                    ...
                    <ul class="product__action--link pos-absolute">
                        <li><a href="little_millet.php"><i class="icon-eye"></i></a></li>
                    </ul>
                </div>
            ...
            <div class="product__box product__default--single text-center col-md-4">
                <div class="product__img-box  pos-relative">
                    ...
                    <ul class="product__action--link pos-absolute">
                        <li><a href="pearl_millet.php"><i class="icon-eye"></i></a></li>
                    </ul>
                </div>
            ...
            <div class="product__box product__default--single text-center col-md-4">
                <div class="product__img-box  pos-relative">
                    ...
                    <ul class="product__action--link pos-absolute">
                        <li><a href="proso_millet.php"><i class="icon-eye"></i></a></li>
                    </ul>
                </div>
            ...
            <div class="product__box product__default--single text-center col-md-4">
                <div class="product__img-box  pos-relative">
                    ...
                    <ul class="product__action--link pos-absolute">
                        <li><a href="redsorghum_millet.php"><i class="icon-eye"></i></a></li>
                    </ul>
                </div>
            ...
            <div class="product__box product__default--single text-center col-md-4">
                <div class="product__img-box  pos-relative">
                    ...
                    <ul class="product__action--link pos-absolute">
                        <li><a href="white_millet.php"><i class="icon-eye"></i></a></li>
                    </ul>
                </div>
