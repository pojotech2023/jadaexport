                ...
                <div class="col-md-5">
                    <div class="product-gallery-box m-b-0">
                        <div class="product-image--gallery overflow-hidden">
                            <h4 class="font--regular m-b-20">FOXTAIL MILLET
                            </h4>
                            <div class="float-left float-grid-1 m-t-0">
                            <div class="img-wrapper">
                                    <img src="../assets/img/product/millats/foxtail.jpg" alt="Rice Image" class="prd-img">
                    ...
                    <div class="product-details-box m-b-0">
                        ...
                        <div class="mt12px pt22px bdrT proDtls">
                            ...
                            <table class="w100 mb15px formTable ">
                                <p>Foxtail Millet (Thinai) is a versatile millet, rich in protein and fiber, commonly used in pongal, salads, and idli.</p>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="p7px">Foxtail Millet</td>
                                    </tr>
                                    <tr>
