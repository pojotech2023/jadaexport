        ...
        <div class="row">
            <div class="col-12">
                <ul class="page-breadcrumb__menu">
                    ...
                    <li class="page-breadcrumb__nav active">Sugar</li>
                </ul>
                ...
                <div class="col-md-5">
                    <div class="product-gallery-box m-b-0">
                        <div class="product-image--gallery overflow-hidden">
                            <h4 class="font--regular m-b-20">SUGAR
                            </h4>
                            <div class="float-left float-grid-1 m-t-0">
                            <div class="img-wrapper">
                                    <img src="../assets/img/product/size-normal/sugar.jpg" alt="Rice Image" class="prd-img">
                ...
                <div class="col-md-7 m-b-0">
                    <div class="product-details-box m-b-0">
                        ...
                        <div class="mt12px pt22px bdrT proDtls">
                            ...
                            <table>
                                <p>Sugar is a sweet, crystalline substance derived from sugarcane or sugar beets, commonly used as a sweetener in beverages, desserts, and various culinary applications.</p>
                                <tbody>

                                    <tr>
                                        <td class="p7px alpha75 w33">Product Name:</td>
                                        <td class="p7px">Sugar</td>
                                    </tr>
