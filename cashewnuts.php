...
<div class="page-breadcrumb">
        ...
        <div class="row">
            <div class="col-12">
                <ul class="page-breadcrumb__menu">
                    ...
                    <li class="page-breadcrumb__nav active">Cashew Nuts </li>
                </ul>
    ...
    <main id="main-container" class="main-container m-t-100">
		...
		<table>
            <p>The leathery leaves are spirally arranged and elliptical in shape. The curved fruit, which is not a true nut, is shaped like a large thick bean and can reach more than 2.5 cm (1 inch) long. It appears as though one of its ends has been forcibly sunk into a pear-shaped swollen stem (hypocarp), called the cashew apple.</p>
				<tbody>
				
				<tr>
				    <td class="p7px alpha75 w33">Product Name:</td>
			         <td class="p7px">Cashew Nut</td>
				</tr>
