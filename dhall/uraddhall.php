                        ...
                        <div class="product-image--gallery overflow-hidden">
                            ...
                            <div class="float-left float-grid-1 m-t-0">
                                <div class="img-responsive border-around">
                                    <img src="../assets/img/product/dhall/uraddhall.png" alt="">
                                </div>
                            </div>
                ...
                <div class="col-md-7 m-b-0">
                    <div class="product-details-box m-b-0">
                        ...
                        <div class="mt12px pt22px bdrT proDtls">
                            ...
                            <table>
                                <p>Black Gram, also known as "Urad Dal," are pulses that, although commonly called lentils, are actually related to cowpeas and mung beans. They originated in India, where they are still an important culinary ingredient, used in popular dishes such as dal makhani, dosa and papadum.</p>
                                <tbody>

                                    <tr>
                                        <td class="p7px alpha75 w33">Product Name:</td>
                                        <td class="p7px">Urad Dhall</td>
                                    </tr>
