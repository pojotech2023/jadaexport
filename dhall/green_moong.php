                ...
                <div class="col-md-5">
                    <div class="product-gallery-box m-b-0">
                        <div class="product-image--gallery overflow-hidden">
                            <h4 class="font--regular m-b-20">GREEN MOONG DHALL
                            </h4>
                            <div class="float-left float-grid-1 m-t-0">
                            <div class="img-wrapper">
                                    <img src="../assets/img/product/dhall/Moong-Dal.webp" alt="Rice Image" class="prd-img">
                    ...
                    <div class="product-details-box m-b-0">
                        ...
                        <div class="mt12px pt22px bdrT proDtls">
                            ...
                            <table class="w100 mb15px formTable ">
                                <p>Green Moong Dal is a nutrient-rich, split green gram known for its mild flavor, soft texture, and high protein content, commonly used in soups, curries, and salads.
                                </p>
                                <!--<h5>Features</h5>-->
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="p7px">Green Moong Dhall</td>
                                    </tr>
                                    <tr>
