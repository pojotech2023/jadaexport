...
<div class="page-breadcrumb">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <li class="page-breadcrumb__nav"><a href="../index.php">Home</a></li>
                    ...
                    <li class="page-breadcrumb__nav active"><a href="dhall.php">Dhall</a></li>
                </ul>
    ...
    <main id="main-container" class="main-container m-t-100">
                            ...
                            <div class="product-image--gallery overflow-hidden">
                                ...
                                <div class="float-left float-grid-1 m-t-0">
                                    <div class="img-responsive border-around">
                                        <img src="../assets/img/product/dhall/toordhal.png" alt="">                  
                                    </div>
                                </div>
		...
		<table>
            <p>Skinned and split toovar is also, known as pigeon peas. It is a major source of protein and many other nutrients for vegetarians. It is the most widely-used form of lentil. Popular recipes like South India sambhar, Gujarati dals, the famous puran poli and lots of other tasty Indian dishes are made using toor dal.</p>
				<tbody>
				
				<tr>
				    <td class="p7px alpha75 w33">Product Name:</td>
			         <td class="p7px">Toor Dhall</td>
				</tr>
