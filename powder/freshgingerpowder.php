...
<div class="page-breadcrumb">
    ...
    <main id="main-container" class="main-container m-t-100">
		...
		<table>
            <p>Fresh ginger is sweeter, more pungent, and has an overall more complex flavor than ground ginger. Chemical composition: Ground ginger contains fewer essential oils and less gingerol than fresh ginger but more shogaol, which is spicy and pungent.</p>
				<tbody>
				
				<tr>
				    <td class="p7px alpha75 w33">Product Name:</td>
			         <td class="p7px">Fresh Ginger & Powder</td>
				</tr>
