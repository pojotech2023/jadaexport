                ...
                <div class="col-md-5">
                    <div class="product-gallery-box m-b-0">
                        <div class="product-image--gallery overflow-hidden">
                            <h4 class="font--regular m-b-20">CORIANDER POWDER
                            </h4>
                            <div class="float-left float-grid-1 m-t-0">
                                <div class="img-wrapper">
                                    <img src="../assets/img/product/powder/coriander.webp" alt="Rice Image" class="prd-img">
                ...
                <div class="col-md-7 m-b-0">
                    <div class="product-details-box m-b-0">
                        ...
                        <div class="mt12px pt22px bdrT proDtls">
                            ...
                            <table>
                                <p>Coriander Powder is a fragrant, mildly citrusy spice made from ground coriander seeds, commonly used in curries, spice blends, and seasoning for various dishes.</p>
                                <tbody>

                                    <tr>
                                        <td class="p7px alpha75 w33">Product Name:</td>
                                        <td class="p7px">Coriander Powder</td>
                                    </tr>
