...
<div class="page-breadcrumb">
    ...
    <main id="main-container" class="main-container m-t-100">
                            ...
                            <div class="product-image--gallery overflow-hidden">
                                ...
                                <div class="float-left float-grid-1 m-t-0">
                                    <div class="img-responsive border-around">
                                        <img src="../assets/img/product/powder/turmericpowder.png" alt="">                  
                                    </div>
                                </div>
		...
		<table>
            <p>Turmeric is the traditional yellow colored root belonging to the family of inger. Commonly used as herb and spice worldwide, its properties make it smell poignant and strong in flavor which is a little bitter, hot and earthy in taste. It is consumed fresh as well in dried form, which is termed as spice.</p>
				<tbody>
				
				<tr>
				    <td class="p7px alpha75 w33">Product Name:</td>
			         <td class="p7px">Turmeric Powder</td>
				</tr>
