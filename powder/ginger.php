                ...
                <div class="col-md-5">
                    <div class="product-gallery-box m-b-0">
                        <div class="product-image--gallery overflow-hidden">
                            <h4 class="font--regular m-b-20">GINGER POWDER
                            </h4>
                            <div class="float-left float-grid-1 m-t-0">
                                <div class="img-wrapper">
                                    <img src="../assets/img/product/powder/ginger.webp" alt="Rice Image" class="prd-img">
                ...
                <div class="col-md-7 m-b-0">
                    <div class="product-details-box m-b-0">
                        ...
                        <div class="mt12px pt22px bdrT proDtls">
                            ...
                            <table>
                                <p>Ginger Powder is a finely ground spice made from dried ginger root, known for its warm, pungent flavor and medicinal properties, commonly used in cooking, teas, and herbal remedies.</p>
                                <tbody>

                                    <tr>
                                        <td class="p7px alpha75 w33">Product Name:</td>
                                        <td class="p7px">Ginger Powder</td>
                                    </tr>
