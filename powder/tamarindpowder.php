...
<div class="page-breadcrumb">
    ...
    <main id="main-container" class="main-container m-t-100">
                            ...
                            <div class="product-image--gallery overflow-hidden">
                                ...
                                <div class="float-left float-grid-1 m-t-0">
                                    <div class="img-responsive border-around">
                                        <img src="../assets/img/product/powder/tamarindpowder.png" alt="">                  
                                    </div>
                                </div>
		...
		<table>
            <p>Tamarind powder is made from dehydrated and ground tamarind. The flavor is highly concentrated as opposed to fresh tamarind and is intensely more sweet-and-sour. The flavor is often used to add a puckeriness to sauces, chutneys, lentil and legume dishes, and pickles.</p>
				<tbody>
				
				<tr>
				    <td class="p7px alpha75 w33">Product Name:</td>
			         <td class="p7px">Tamarind Powder</td>
				</tr>
