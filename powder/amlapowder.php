...
<div class="page-breadcrumb">
    ...
    <main id="main-container" class="main-container m-t-100">
                            ...
                            <div class="product-image--gallery overflow-hidden">
                                ...
                                <div class="float-left float-grid-1 m-t-0">
                                    <div class="img-responsive border-around">
                                        <img src="../assets/img/product/powder/amlapowder.png" alt="">                  
                                    </div>
                                </div>
		...
		<table>
            <p>Amla powder is made from the ground-up leaves of the Indian gooseberry. It's been used in Ayurvedic medicine for centuries to treat everything from diarrhea to jaundice. people to chalk it up as the next big thing in beauty.</p>
				<tbody>
				
				<tr>
				    <td class="p7px alpha75 w33">Product Name:</td>
			         <td class="p7px">Amla Powder</td>
				</tr>
