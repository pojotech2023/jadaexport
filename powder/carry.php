...
<div class="page-breadcrumb">
    ...
    <main id="main-container" class="main-container m-t-100">
                   ...
                   <div class="col-md-5">
                        <div class="product-gallery-box m-b-0">
                            <div class="product-image--gallery overflow-hidden">
                                <h4 class="font--regular m-b-20">CURRY LEAF POWDER
</h4>
                                <div class="float-left float-grid-1 m-t-0">
                                <div class="img-wrapper">
                                    <img src="../assets/img/product/powder/carry1.webp" alt="Rice Image" class="prd-img">
		...
		<table>
            <p>Curry Leaf Powder is made from dried curry leaves, known for its aromatic, slightly bitter flavor, and is often used to enhance the taste of South Indian dishes, chutneys, and soups.</p>
				<tbody>
				
				<tr>
				    <td class="p7px alpha75 w33">Product Name:</td>
			         <td class="p7px">Curry Leaf Powder</td>
				</tr>
