...
<div class="page-breadcrumb">
    ...
    <main id="main-container" class="main-container m-t-100">
                            ...
                            <div class="product-image--gallery overflow-hidden">
                                ...
                                <div class="float-left float-grid-1 m-t-0">
                                    <div class="img-responsive border-around">
                                        <img src="../assets/img/product/powder/mintleafpowder.png" alt="">                  
                                    </div>
                                </div>
		...
		<table>
            <p>Mint tastes sweet and produces a lingering cool effect on the tongue. Peppermint has a stronger flavor with more menthol taste. The fresh leaves have the most flavor and scent, with those much reduced in dried mint leaves.</p>
				<tbody>
				
				<tr>
				    <td class="p7px alpha75 w33">Product Name:</td>
			         <td class="p7px">Mint Leaf Powder</td>
				</tr>
