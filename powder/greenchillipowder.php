...
<div class="page-breadcrumb">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <li class="page-breadcrumb__nav"><a href="../index.php">Home</a></li>
                    ...
                    <li class="page-breadcrumb__nav active"><a href="powder.php">Powder</a></li>
                </ul>
    ...
    <main id="main-container" class="main-container m-t-100">
                            ...
                            <div class="product-image--gallery overflow-hidden">
                                ...
                                <div class="float-left float-grid-1 m-t-0">
                                    <div class="img-responsive border-around">
                                        <img src="../assets/img/product/powder/greenchillipowder.png" alt="">                  
                                    </div>
                                </div>
		...
		<table>
            <p>Green chilli powder is the result of drying fresh picked green chilli peppers, removing the stems, and then grinding into a powder. It is widely used in dry soups mixes, stuffing mixes, fast foods, sauces, food preparations and vegetable mixes, the offered powder is known for its extended shelf life and spicy taste.</p>
				<tbody>
				
				<tr>
				    <td class="p7px alpha75 w33">Product Name:</td>
			         <td class="p7px">Green Chilli & Powder</td>
				</tr>
