...
<div class="page-breadcrumb">
        ...
        <div class="row">
            <div class="col-12">
                <ul class="page-breadcrumb__menu">
                    ...
                    <li class="page-breadcrumb__nav active">yellowmaize</li>
                </ul>
    ...
    <main id="main-container" class="main-container m-t-100">
                   ...
                   <div class="col-md-5">
                        <div class="product-gallery-box m-b-0">
                            <div class="product-image--gallery overflow-hidden">
                                <h4 class="font--regular m-b-20">YELLOW MAIZE
</h4>
                                <div class="float-left float-grid-1 m-t-0">
                                    <div class="img-responsive border-around">
                                        <img src="assets/img/product/size-normal/yellowmaize.png" alt="">                  
                                    </div>
                                </div>
		...
		<table>
            <p>Yellow maize grows on stalks, commonly referred to as corn stalks, with each stalk producing several ears of corn with hundreds of kernels. The kernels are commonly eaten cooked, while the dried kernels are used for animal feed or ground into flour for baking. An ear of corn, also called maize.</p>
				<tbody>
				
				<tr>
				    <td class="p7px alpha75 w33">Product Name:</td>
			         <td class="p7px">Yellow Maize</td>
				</tr>
