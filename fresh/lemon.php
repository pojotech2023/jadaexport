...
<div class="page-breadcrumb">
    ...
    <main id="main-container" class="main-container m-t-100">
                            ...
                            <div class="product-image--gallery overflow-hidden">
                                ...
                                <div class="float-left float-grid-1 m-t-0">
                                    <div class="img-responsive border-around">
                                        <img src="../assets/img/product/fresh/lemon.png" alt="">                  
                                    </div>
                                </div>
		...
		<table>
            <p>An oval yellow fruit with a sour juice that is related to the orange and grows on a small spiny tree. 2 : something unsatisfactory : dud The used car was a lemon. lemon. noun. lem·on | \ ˈlem-ən \</p>
				<tbody>
				
				<tr>
				    <td class="p7px alpha75 w33">Product Name:</td>
			         <td class="p7px">Fresh Lemon</td>
				</tr>
