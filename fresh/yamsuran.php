...
<div class="page-breadcrumb">
    ...
    <main id="main-container" class="main-container m-t-100">
                   ...
                   <div class="col-md-5">
                        <div class="product-gallery-box m-b-0">
                            <div class="product-image--gallery overflow-hidden">
                                <h4 class="font--regular m-b-20">YAM OR SURAN 
</h4>
                                <div class="float-left float-grid-1 m-t-0">
                                    <div class="img-responsive border-around">
                                        <img src="../assets/img/product/fresh/yamsuran.png" alt="">                  
                                    </div>
                                </div>
		...
		<table>
            <p>Yam plants have thick tubers (generally a development of the base of the stem) which often have thick, almost barklike skin. The long, slender, annual, climbing stems bear lobed or entire leaves that are either alternate or opposite. The unisexual flowers are borne in long clusters.</p>
				<tbody>
				
				<tr>
				    <td class="p7px alpha75 w33">Product Name:</td>
			         <td class="p7px">Yam or Suran</td>
				</tr>
