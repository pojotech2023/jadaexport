...
<div class="page-breadcrumb">
    ...
    <main id="main-container" class="main-container m-t-100">
                   ...
                   <div class="col-md-5">
                        <div class="product-gallery-box m-b-0">
                            <div class="product-image--gallery overflow-hidden">
                                <h4 class="font--regular m-b-20">FRESH DRUMSTICKS
</h4>
                                <div class="float-left float-grid-1 m-t-0">
                                    <div class="img-responsive border-around">
                                        <img src="../assets/img/product/fresh/drumsticks.png" alt="">                  
                                    </div>
                                </div>
		...
		<table>
            <p>As an antioxidant, it seems to help protect cells from damage. Moringa might also help decrease inflammation and reduce pain. Moringa is used for asthma, diabetes, breast-feeding, and many other purposes, but there is no good scientific evidence to support these uses.</p>
				<tbody>
				
				<tr>
				    <td class="p7px alpha75 w33">Product Name:</td>
			         <td class="p7px">Drumsticks</td>
				</tr>
