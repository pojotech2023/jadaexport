                ...
                <div class="col-md-5">
                    <div class="product-gallery-box m-b-0">
                        <div class="product-image--gallery overflow-hidden">
                            <h4 class="font--regular m-b-20">RNR RICE
                            </h4>
                            <div class="float-left float-grid-1 m-t-0">
                                <div class="img-wrapper">
                                    <img src="../assets/img/product/rice/rnr.jpg" alt="Rice Image" class="prd-img">
                    ...
                    <div class="product-details-box m-b-0">
                        ...
                        <div class="mt12px pt22px bdrT proDtls">
                            ...
                            <table class="w100 mb15px formTable ">
                                <p>RNR Rice is a high-yield, medium-grain variety known for its fine texture and aroma, commonly used in traditional meals and dishes like pulao and fried rice.
                                </p>
                                <!--<h5>Features</h5>-->
