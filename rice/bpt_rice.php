                    ...
                    <div class="product-details-box m-b-0">
                        ...
                        <div class="mt12px pt22px bdrT proDtls">
                            ...
                            <table class="w100 mb15px formTable ">
                                <p>BPT Rice, also known as Biris, is a high-quality, long-grain rice variety prized for its fragrant aroma, soft texture, and ideal use in biryanis and other rice-based dishes.
                                </p>
                                <!--<h5>Features</h5>-->
