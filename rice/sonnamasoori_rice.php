                ...
                <div class="col-md-5">
                    <div class="product-gallery-box m-b-0">
                        <div class="product-image--gallery overflow-hidden">
                            <h4 class="font--regular m-b-20">SONNA MASOORI RICE
                            </h4>
                            <div class="float-left float-grid-1 m-t-0">
                            <div class="img-wrapper">
                                    <img src="../assets/img/product/rice/sona.jpeg" alt="Rice Image" class="prd-img">
                    ...
                    <div class="product-details-box m-b-0">
                        ...
                        <div class="mt12px pt22px bdrT proDtls">
                            ...
                            <table class="w100 mb15px formTable ">
                                <p>Sonna Masoori Rice is a premium, aromatic, medium-grain rice variety, popular for its light texture and distinct fragrance, often used in South Indian dishes.
                                </p>
                                <!--<h5>Features</h5>-->
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="p7px">Sonna Masoori Rice</td>
                                    </tr>
                                    <tr>
