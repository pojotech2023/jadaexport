...
<div class="page-breadcrumb">
        ...
        <div class="row">
            <div class="col-12">
                <ul class="page-breadcrumb__menu">
                    ...
                    <li class="page-breadcrumb__nav active">Coconuts</li>
                </ul>
    ...
    <main id="main-container" class="main-container m-t-100">
                   ...
                   <div class="col-md-5">
                        <div class="product-gallery-box m-b-0">
                            <div class="product-image--gallery overflow-hidden">
                                <h4 class="font--regular m-b-20">COCONUTS
</h4>
                                <div class="float-left float-grid-1 m-t-0">
                                    <div class="img-responsive border-around">
                                        <img src="assets/img/product/size-normal/coconuts.png" alt="">                  
                                    </div>
                                </div>
		...
		<table>
            <p>A coconut is a large, nut-like fruit that grows high in trees. Coconuts have very hard shells and sweet, white flesh inside. The white, flaked coconut you can buy in a bag at the grocery store is a processed form of the coconut fruit.</p>
				<tbody>
				
				<tr>
				    <td class="p7px alpha75 w33">Product Name:</td>
			         <td class="p7px">Coconuts</td>
				</tr>
